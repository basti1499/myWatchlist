 ...
 */
package dhbwka.wwi.vertsys.javaee.mywatchlist.common.web;
...
public class SignUpServlet extends HttpServlet {
    ...
    /**
     * Reagiert auf GET-Anfragen, zeigt die Seite an.
     * @param request
     * @param response
    ...
    /**
     * Reagiert auf POST-Anfragen, validiert Nutzereingaben und fügt
     * diese, falls korrekt, in die Datenbank ein.
     * @param request
     * @param response
     * @throws ServletException
     * @throws IOException 
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (errors.isEmpty()) {
            try {
                this.userBean.signup(username, password1, vorname, nachname, alter);
